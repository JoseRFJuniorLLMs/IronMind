...
extern "C" {
    WHISPER_API int whisper_full_simple(struct whisper_context * ctx, const float * samples, int n_samples) {
        return whisper_full(ctx, whisper_full_default_params(WHISPER_SAMPLING_GREEDY), samples, n_samples);
    }
}
